    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white px-3.5 py-1.5 rounded-lg text-xs font-semibold transition-colors border border-slate-700 cursor-pointer"
            >
      ...
      <div className="flex flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 gap-6">
        ...
        <aside className="w-60 shrink-0 hidden md:block">
          <nav className="bg-white border border-slate-200 rounded-xl p-3 shadow-sm space-y-1 sticky top-22">
